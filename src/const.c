 ...
 */
  ...
  */
 ...
 
     {
      ...
      {
        "prismatic beam",       1,
        spell_prismatic_beam,   TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
        NULL,                   SLOT(206),       50,     10,
        "beam of colors",       "!Prismatic Beam!"
     },
...
*/ 
     ...
     },
 {
	...
	"shadowblast",		      99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_shadowblast,	SLOT(0),	   0,	  24,
	"shadowblast",		      "!shadowblast!"
     },	
     {
        "spin kick",              2,
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
        &gsn_spin,           SLOT( 0),        0,     24,
        "",                     "!spin kick!"
     },
     {
         "leech",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_leech,            SLOT( 0),        0,     24,
         "leech",         	"!leech!"
     },
     {
         "riposte",               13,
     ...
     },
     {
         "feint",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_feint,            SLOT( 0),        0,     24,
         "feint",               "!feint!"
     },
     {
         "mind blast",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_mindblast,            SLOT( 0),        0,     24,
         "mind blast",               "!mind blast!"
     },
     {
         "enfeeblement",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_enfeeble,            SLOT( 0),        0,     24,
         "enfeeblement",               "!enfeeblement!"
     },

      {
        "super gas",       13,
        spell_super_gas,   TAR_IGNORE,     POS_FIGHTING,
        NULL,                   SLOT(206),       50,     10,
        "blast of super gas",       "!Super Gas Breath!"
     },
      {
        "critical strike",       13,
        spell_null,   TAR_IGNORE,     POS_FIGHTING,
        &gsn_critical_hit,                   SLOT(206),       0,     24,
        "critical strike",       "!Criticalhit!"
     },
      {
        "slide kick",       13,
        spell_null,   TAR_IGNORE,     POS_FIGHTING,
        &gsn_slide,                   SLOT(206),       0,     24,
     ...
     },
      {
        "hilt strike",       13,
        spell_null,   TAR_IGNORE,     POS_FIGHTING,
        &gsn_hiltstrike,                   SLOT(206),       0,     24,
        "hilt strike",       "!hilt strike!"
     },
      {
        "critical strike",       13,
        spell_null,   TAR_IGNORE,     POS_FIGHTING,
     ...
     },
      {
        "shinku",       13,
        spell_null,   TAR_IGNORE,     POS_FIGHTING,
        &gsn_shinku,                   SLOT(206),       0,     24,
        "tackle",       "!shinku!"
     },
      {
        "kisetsufuu",       13,
        spell_null,   TAR_IGNORE,     POS_FIGHTING,
        &gsn_kisetsufuu,                   SLOT(206),       0,     24,
        "kisetsufuu",       "!kisetsufuu!"
     },
      {
        "kaminari",       13,
        spell_null,   TAR_IGNORE,     POS_FIGHTING,
        &gsn_kaminari,                   SLOT(206),       0,     24,
        "kaminari",       "!kaminari!"
     },
      {
        "inabikari",       13,
        spell_null,   TAR_IGNORE,     POS_FIGHTING,
        &gsn_inabikari,                   SLOT(206),       0,     24,
        "inabikari",       "!inabikari!"
     },

     {
         "divine wrath",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_divinewrath,            SLOT( 0),        0,     24,
         "divine wrath",               "!divinewrath!"
     },
      {
        "super blind",       13,
        spell_super_blind,   TAR_IGNORE,     POS_FIGHTING,
        NULL,                   SLOT(206),       50,     10,
        "super blind",       "!super blind!"
     },
     {
         "inquisitor",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_inquisitor,            SLOT( 0),        0,     24,
         "inquisitor",               "!inquisitor!"
     },
     {
         "unholytorment",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_unholytorment,            SLOT( 0),        0,     24,
         "unholy torment",               "!unholytorment!"
     },
     {
         "purify",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_purify,            SLOT( 0),        0,     24,
         "unholy purification",               "!purify!"
     },
     {
         "slash",               13,
         spell_null,             TAR_IGNORE,             POS_STANDING,
         &gsn_slash,            SLOT( 0),        0,     24,
         "slash",               "!slash!"
     },
     {
        "miracle",                 1,
        spell_miracle,             TAR_CHAR_DEFENSIVE,     POS_FIGHTING,
        NULL,                   SLOT(28),       10000,     18,
        "",                     "!miracle!"
     },

     {
        "knock",                 2,
        spell_null,             TAR_IGNORE,     POS_FIGHTING,
        &gsn_knock,           SLOT(28),       0,     18,
        "knock",                     "!knock!"
     },
     {
        "riftwalk",                 3,
        spell_null,             TAR_IGNORE,     POS_STANDING,
        &gsn_riftwalk,           SLOT(28),       0,     18,
        "riftwalk",                     "!riftwalk!"
     },
     {
        "recall",                 2,
        spell_null,             TAR_IGNORE,     POS_FIGHTING,
        &gsn_recall,           SLOT(28),       0,     18,
        "recall",                     "!recall!"
     }
...
/* owner        title           char_msg        vict_msg        room_msg */
  ...
  },
  {
    ...
    "Your vision goes negative as $n's searing bolt of balefire annhilates you!",    
...
void do_slay( CHAR_DATA *ch, char *argument )
{
    ...
    if ( victim == supersnard )
    {
        send_to_char( "You cannot slay superSnard!\n\r", ch );
        bug( "trying to slay superSnard", ch );
	return;
    }
     ...
     if ( type[0] == '\0' )
       {
	  act( "You brutely slay $N.",ch,NULL,victim,TO_CHAR, FALSE);
	  act( "$n brutely slays you.",ch,NULL,victim,TO_VICT, FALSE);
	  act( "$n brutely slays $N.",ch,NULL,victim,TO_NOTVICT, FALSE);
	  if (!IS_NPC(victim))
	  {
	  sprintf(buf, "#R%s#n #0slays #y%s#n in #Rcold blood!#n",ch->pcdata->switchname,victim->pcdata->switchname);
	  do_info(ch,buf);
  	  }
          raw_kill(victim);
          return;
